...
// Setup 4: Microservices via network Eden Treaty
// A and B run as fully separate HTTP services on their own ports.
// The public AB controller calls them in parallel via `treaty('host:port')`.
...
const clientA = treaty<typeof controllerA>('localhost:3001')
const clientB = treaty<typeof controllerB>('localhost:3002')
